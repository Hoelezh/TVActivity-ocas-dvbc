...
import com.nmp.update.UpdateVersionService;
...
public class TVActivity extends Activity implements 
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    new Handler().postDelayed(new Runnable() {  
            ...
            private String UPDATEVERSIONXMLPATH = "http://210.209.93.38/m3932/version.xml";

            @Override  
            public void run() {  
                // TODO Auto-generated method stub  
                updateVersionService = new UpdateVersionService(UPDATEVERSIONXMLPATH , TVActivity.this);// ��������ҵ�����  
	...
	private void updateChannels() {
    	...
    	// 绉诲姩鐒︾偣鐨勬柟寮忔槸鍏夋爣鍋滅暀鍦ㄥ垪琛ㄤ腑闂达紝鐩村埌鍓嶅悗娌℃湁鏁版嵁浜嗭紝鍏夋爣鎵嶅悜鍓嶅悗绉诲姩
    	int startIdx = 0;
	...
	public void onPrepared(MediaPlayer mp) {
		...
		// 纭繚鎾斁璧锋潵鍚庢墠寮�濮嬭绠楅殣钘弍laybar鐨勬椂闂�?		
		int msg = MSG_HIDE_PLAYBAR;
		int timeout = ShowListTimeout;
		this.mMsgHandler.removeMessages(msg);
		this.mMsgHandler.sendEmptyMessageDelayed(msg, timeout);
		// 纭繚鎾斁璧锋潵鍚庢墠淇濆瓨涔嬪墠鐨勯�夋簮閫夐泦璁板�?		
	...
	public boolean onError(MediaPlayer mp, int what, int extra) {
		this.updateFavList();
		if (null == this.mEpgItem) { // 鍥炵湅杩囩▼涓挱鏀惧嚭閿欎笉闇�瑕佹崲婧�
