...
public class UpdateVersionService {
    ...
    private String fileSavePath;// 下载新apk的存放地点
    ...
    public void checkUpdate() {
        ...
        showUpdateVersionDialog(isUpdate());
    }

    /**
     * 更新提示框
     */
    private void showUpdateVersionDialog(Boolean new_version) {
        // 构造对话框
    ...
    private int getVersionCode(Context context2) {
        ...
        try {
            ...
            versionCode = context.getPackageManager().getPackageInfo("com.nmp.dvbplayer", 0).versionCode;
    ...
    public void uninstallAPK() {
        Uri packageURI = Uri.parse("package:com.nmp.dvbplayer");
